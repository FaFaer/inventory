...
<div id="jquery-accordion-menu" class="jquery-accordion-menu red">
	...
	<div id="content">
		<!--内容-->
		<h1>出库经销商</h1>
		<form action="${pageContext.request.contextPath}/InOutS?op=out2" method="post">
		经销商：<select class="form-control" name = "dealerId" style="display: inline-block;margin-top: 100px; margin-bottom: 100px; width: 400px;">
		<c:forEach items="${requestScope.dealers}" var="dealer">
		<option value="${dealer.getDealerId()}">${dealer.getDealerName()}</option>
		</c:forEach>
		</select><br />
		<input type="submit" value="出库" class="btn btn-lg" />
		</form>
	</div>

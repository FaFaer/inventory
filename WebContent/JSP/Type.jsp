...
<%@page import="mode.Producetype"%><%@page import="mode.Admin"%>
...
<div id="content">
			...
			<h1>商品类型管理</h1>
				...
				<div id="search" style="margin-top: 20px;">
						<input type="search" class="form-control" id="searchin" placeholder="请输入需要查询的商品类型" style="width: 400px; display: inline-block;" /> 
						<input class="btn btn-default btn-lg"id="searchbut" style="margin-left: 20px;" type="button" value="查询" /> 
			...
			<div id="select">
				<div id="topname">
					<span>商品类型</span><span>描述</span>
				</div>
				<table class="table-hover"
					style="width: 580px; margin: 0px auto; font-size: 16px; display: inline-block;" id="sel">
			</table>
			</div>
		...
		$(function() {
			...
			xmlHttpReq.open("POST","${pageContext.request.contextPath}/ProduceS?op=distype1",true);
